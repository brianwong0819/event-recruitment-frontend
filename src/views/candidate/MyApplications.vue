          ...
          >
            <div class="flex">
              ...
              <div class="ml-3">
                ...
                <!-- Special warning for HIRED status withdrawals -->
                <div
                  v-if="withdrawApplication?.status === 'HIRED'"
                  class="mt-2 mb-3 p-2 bg-red-100 rounded-md border border-red-300"
                >
                  <p class="text-sm font-bold text-red-700">
                    <i class="pi pi-exclamation-circle mr-1"></i>
                    Important: Withdrawing from a HIRED position will result in
                    a reputation deduction.
                  </p>
                </div>
